...
[![Build Status](https://travis-ci.org/atomic/sip/library/faker.svg?branch=master)](https://travis-ci.org/atomic/sip/library/faker)
[![codecov](https://codecov.io/gh/atomic/sip/library/faker/branch/master/graph/badge.svg)](https://codecov.io/gh/atomic/sip/library/faker)
[![Go Report Card](https://goreportcard.com/badge/github.com/atomic/sip/library/faker)](https://goreportcard.com/report/github.com/atomic/sip/library/faker)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/atomic/sip/library/faker/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/atomic/sip/library/faker?status.svg)](https://godoc.org/github.com/atomic/sip/library/faker)
...
You can file an [Issue](https://github.com/atomic/sip/library/faker/issues/new).
See documentation in [Godoc](https://godoc.org/github.com/atomic/sip/library/faker)
...
```shell
go get -u github.com/atomic/sip/library/faker
```
## Example
...
import (
	"fmt"
	"github.com/atomic/sip/library/faker"
)
...
### Maintainer
- <a href="https://github.com/atomic/sip/library">  **Iman Tumorang** </a> <br> 
