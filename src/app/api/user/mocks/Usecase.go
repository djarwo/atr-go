...
func (_m *Usecase) Delete(_a0 string) (*models.User, error) {
	ret := _m.Called(_a0)
...
func (_m *Usecase) Find(_a0 string) (*models.User, error) {
	ret := _m.Called(_a0)
...
func (_m *Usecase) FindAll(_a0 string, _a1 string, _a2 string, _a3 string) ([]*models.User, int, error) {
...
func (_m *Usecase) Login(_a0 string, _a1 string, _a2 string, _a3 string) (*models.User, interface{}, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_m *Usecase) Update(_a0 string, _a1 models.User) (*models.User, error) {
